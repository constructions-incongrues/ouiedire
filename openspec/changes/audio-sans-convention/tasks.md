...
- [ ] 2.2 Écrire les tests de l'ordre : la convention historique passe devant, l'alphabétique départage, et le résultat ne dépend pas de l'ordre de parcours du système de fichiers
